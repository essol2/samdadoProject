       ...
       <div class="card" style="width: 99%; height: 180px; border-style: none;">  		           
        ...
        <ul>
        	...
        	<li>
        		...
        		<ul class="ul-class">                
	                <li><a class="nav-link" href="${ contextPath }/admin/qna" id="admin-navi-menu-ad1">&nbsp;&nbsp;&nbsp;- 배너 광고</a></li>
	                <li><a class="nav-link" href="${ contextPath }/admin/qna" id="admin-navi-menu-ad2">&nbsp;&nbsp;&nbsp;- 프리미엄 광고</a></li>
		       </ul>
        	</li>
        </ul>
        <br>
