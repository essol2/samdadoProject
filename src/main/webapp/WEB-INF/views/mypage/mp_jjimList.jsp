        ...
        <section class="page-start">
            <div id="topMenu">
                ...
                <div class="menuBox" id="menuBox">
                    ...
                    <button class="clickedBtn" id="myInfo"> <div class="menuBoxEle"><br><img src="${contextPath}/resources/images/image_mp/mp_jjimW.png" class="btnImg"> <br> 찜목록</div></button>
                ...
                <div id="leftBox" class="reservBox"> 
                    ...
                    <div class="reservDetail">
                        <div class="reserveImgArea">
                            ...
                            <img src="${contextPath}/resources/images/image_mp/image55.png" alt="" class="reserveImg">
                        </div>
                        <div class="reserveContainer">
                            <div id="reserveInfoArea">
                                <img src="${contextPath}/resources/images/image_mp/heartFull.png" alt="" class="jjimHeart"><br>
                                <img src="${contextPath}/resources/images/image_mp/tag-outline.png" alt="" class="reservIcon"><br> 스탠다드 트윈룸, 정원 전망<br><br>
                                <img src="${contextPath}/resources/images/image_mp/location_outline.png" alt="" class="reservIcon"><br> 제주특별자치도 석귀포시 색달동 중문관광로 72번길 75<br><br>
                                <img src="${contextPath}/resources/images/image_mp/phone_outline.png" alt="" class="reservIcon"><br> 064) 735-5114<br><br>
                ...
                <div id="middleBox" class="reservBox">
                    ...
                    <div class="reservDetail">
                        <div class="reserveImgArea">
                            ...
                            <img src="image_mp/image54.png" alt="" class="reserveImg">
                        </div>
                        <div class="reserveContainer">
                            <div id="reserveInfoArea">
                                <img src="${contextPath}/resources/images/image_mp/heartFull.png" alt="" class="jjimHeart"><br>
                ...
                <div id="rightBox" class="reservBox">
                    ...
                    <div class="reservDetail">
                        <div class="reserveImgArea">
                            ...
                            <img src="${contextPath}/resources/images/image_mp/image57.png" alt="" class="reserveImg">
                        </div>
                        <div class="reserveContainer">
                            <div id="reserveInfoArea">
                                <img src="${contextPath}/resources/images/image_mp/heartEmpty.png" alt="" class="jjimHeart"><br>
                                <img src="${contextPath}/resources/images/image_mp/tag-outline.png" alt="" class="reservIcon"><br> 스탠다드 트윈룸, 정원 전망<br><br>
                                <img src="${contextPath}/resources/images/image_mp/location_outline.png" alt="" class="reservIcon"><br> 제주특별자치도 석귀포시 색달동 중문관광로 72번길 75<br><br>
                                <img src="${contextPath}/resources/images/image_mp/phone_outline.png" alt="" class="reservIcon"><br> 064) 735-5114<br><br>
