      ...
      <section class="signup-section-wrap">
            ...
            <div class="signup-div">
                ...
                <span class="box int_pass_check">
                    <input type="text" id="pswd2" class="int">                    
                </span>
                <span class="error_next_box"></span>
            </div>
            ...
            <!-- 영업시간 -->
            <div class="signup-div">
                <h3 class="join-title"><label for="address">영업시간</label></h3>
                <span class="box int_address">
                    <input type="text" id="address" class="int" maxlength="6" placeholder="매일 08:00 ~ 22:00">
                </span>
                <span class="error_next_box"></span>
            </div>         
            ...
            <!-- 브레이크타임 -->
            <div class="signup-div">
                <h3 class="join_title"><label for="email">브레이크타임</label></h3>
                <span class="box int_email">
                    <input type="text" id="email" class="int" maxlength="100" placeholder="매일 15:00 ~ 17:00">
                </span>
                <span class="error_next_box"></span>    
            </div>
            ...
            <!-- 메뉴판 사진 -->
            <div class="signup-div">
                <h3 class="join_title"><label for="phoneNo">메뉴판 사진</label></h3>
            ...
            <div class="signup-div">
                ...
                <span class="box int_mobile">
                    <input type="file"  name="res_main_file" id="mobile" class="int" maxlength="16">
                </span>
                <span class="error_next_box"></span>    
            </div>
